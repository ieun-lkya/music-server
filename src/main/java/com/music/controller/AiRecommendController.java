...
public class AiRecommendController {
    ...
    public Result<List<Map<String, Object>>> generatePlaylists() {
        ...
        try {
            ...
            //  终极 Prompt：强行拔掉它的“学术伪装”，逼它像网易云热评一样说人话！
            String prompt = String.format(
                    "你是一个极具情感共鸣、但【说话极其通俗接地气】的音乐主理人。当前随机时空指纹为：【%s】。\n" +
                    "请仔细阅读下方的【曲库全集】：\n%s\n" +
                    "【你的使命】：\n" +
                    "1. 请完全摆脱任何已知的音乐分类模板，利用你庞大的知识图谱，自发创造 4 个独特、能击中人心的歌单主题。\n" +
                    "2. 【重点约束】：为每个歌单撰写一个【分类依据(basis)】。**必须用极度通俗易懂、像朋友聊天一样的白话文！绝对禁止使用“声学韧性”、“故障感”、“旋律核”这类装逼、晦涩难懂的学术词汇！** 告诉我这几首歌带给人的共同感受、或者它们适合在什么场景下听，让人一听就懂（不少于40字）。\n" +
                    "3. 遍历上方曲库中的**所有**歌曲，把**所有**符合该主题意境的歌曲 ID 全部挑选出来放入 ids 数组，应收尽收！\n" +
